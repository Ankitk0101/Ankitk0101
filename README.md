...
## 👨‍💼 Bio
I'm a passionate **Full Stack Developer** from Bihar, India, focused on creating scalable, efficient, and user-friendly web applications.  
Currently pursuing **MERN Stack Development** at Masai School, I love exploring modern technologies and building real-world projects.

- 🌱 **Exploring:** Next.js, TypeScript, System Design  
- 💼 **Open to:** Full-time Developer Roles & Freelance Projects  
...
A productivity web app that helps users **build, track, and analyze habits** through visual progress and Firebase authentication.  
Users can create daily/weekly habits, track performance, and stay consistent.  
...
🏷️ *Tags:* Productivity • Habit Tracking • Authentication  

---

### 🌍 [TravelPath - Destination Recommendation Platform](https://destination-recommendation-platform-3.onrender.com/)
A smart travel planner that **recommends destinations and optimal routes** between cities using real-time data.  
Users can explore routes, compare transport modes, and view station details.
...
🏷️ *Tags:* Travel • Recommendation • Full Stack  

---

### 🏠 [Smart Home System](https://smart-home-ankit-kumar.netlify.app/)
A **real-time IoT dashboard** to manage and monitor smart devices with Firebase integration.  
...
<div align="center">
  <h3>💻 <b>Code. Create. Innovate.</b></h3>
